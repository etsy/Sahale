var DataUtil = (function() {
	...
	step.gs_bytes_read		  = checkedStepUnpack(step, 'mapreduce.FileSystemCounter', 'GS_BYTES_READ', null);
    step.gs_bytes_written	  = checkedStepUnpack(step, 'mapreduce.FileSystemCounter', 'GS_BYTES_WRITTEN', null);
